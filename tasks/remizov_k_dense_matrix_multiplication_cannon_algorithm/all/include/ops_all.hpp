...
class RemizovKDenseMatrixMultiplicationCannonAlgorithmAll : public BaseTask {
 public:
  static constexpr ppc::task::TypeOfTask GetStaticTypeOfTask() {
    return ppc::task::TypeOfTask::kALL;
  }

  explicit RemizovKDenseMatrixMultiplicationCannonAlgorithmAll(const InType &in);
 ...
 private:
  ...
  static void MultiplyBlock(const std::vector<std::vector<double>> &a,
                            const std::vector<std::vector<double>> &b,
                            std::vector<std::vector<double>> &c,
                            int block_size);

  static void ShiftBlocksLeft(
      std::vector<std::vector<std::vector<std::vector<double>>>> &matrix_blocks,
      int block_count);

  static void ShiftBlocksUp(
      std::vector<std::vector<std::vector<std::vector<double>>>> &matrix_blocks,
      int block_count);

  static void RunCannonCycle(
